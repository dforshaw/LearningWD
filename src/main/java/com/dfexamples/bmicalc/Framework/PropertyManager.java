...
import static com.dfexamples.bmicalc.Framework.Enums.Browser.BROWSER_CHROME;
import static com.dfexamples.bmicalc.Framework.Enums.PathConfig.PROJECT_PROPERTIES_PATH;
...
public class PropertyManager {
    ...
    public static String getProperty(String key) {
        if (properties.isEmpty()) {
            com.dfexamples.bmicalc.Framework.PropertyManager.Initialize();
        }
