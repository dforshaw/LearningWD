package com.dfexamples.bmicalc.Framework;

import com.dfexamples.bmicalc.Framework.PropertyManager;
...
import static com.dfexamples.bmicalc.Framework.Enums.PathConfig.*;
import static com.dfexamples.bmicalc.Framework.Enums.PathConfig.PATH_TO_GECKO_DRIVER;
...
public class DriverManager {
    ...
    public static String ProjHomeDir = UserHomeDir + PROJ_LOCATION_HOME.getPath();
...
//    public static String BrowserDriverVendorDir = ProjHomeDir + "/.." + WEBDRIVER_CLIENTS.getPath();
    ...
    public static void waitForClickable(By locator, int timeUnit) {
        WebDriverWait wait = new WebDriverWait(com.dfexamples.bmicalc.Framework.DriverManager.DriverInstance,timeUnit);
